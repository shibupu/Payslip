...
// var pathToImages = 'http://localhost/images/calender/';    // Relative to your HTML file (live server)
var pathToImages = 'http://46.23.76.237/images/calender/';    // Relative to your HTML file (live server)
...
function getTopPos(inputObj, scroll_div)
{
    var returnValue = inputObj.offsetTop + inputObj.offsetHeight;
    while((inputObj = inputObj.offsetParent) != null)returnValue += inputObj.offsetTop;
    if (scroll_div) {returnValue = returnValue - scroll_div};
...
function positionCalendar(inputObj, scroll_div)
{
    calendarDiv.style.left = getleftPos(inputObj) + 'px';
    calendarDiv.style.top = getTopPos(inputObj, scroll_div) + 'px';
    if(iframeObj){
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput, scroll_div)
{
    ...
    positionCalendar(buttonObj, scroll_div);
